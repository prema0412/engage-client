...
import PrepareEngagementList from '../../components/EngagementList/EngagementList';
    ...
    return (
        <div className="main">
            ...
            <Routes>
                ...
                <Route path='/engagements' element={<EngagementList className="engagement" engagamentList={engagementList} header={"Explore Engagements"}/>} />
